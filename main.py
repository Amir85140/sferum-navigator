...
body{font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;background:#0a0a0a;color:#fff;height:100vh}
.app{display:flex;height:100vh}
.nav{width:70px;background:#121212;border-right:1px solid #2a2a2a}
.history{width:280px;background:#121212;border-right:1px solid #2a2a2a;padding:20px}
...
document.getElementById('ideasList').innerHTML=ideas.map(i=>`<div class="idea" onclick="selectIdea('${i.id}','${i.name}')">${i.name}</div>`).join('');
}
